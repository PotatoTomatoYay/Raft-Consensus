...
var log_path = flag.String("log_path", "./logs/", "path to log directory")
var timeout = flag.Int("timeout", 500, "minimum follower/candidate timeout duration, in milliseconds")
var timeout_randomness = flag.Int("timeout_randomness", 250, "additional duration for random timeouts, in milliseconds")
